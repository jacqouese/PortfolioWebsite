    ...
    <div className="projects-section">
        ...
        {projects.map(project =>
            ...
            >
               ...
               <div>
                    <a href="https://www.github.com" className="project-button" style={{backgroundColor: project.colors.darker}}>Detailed info</a>
                    <a href={project.url} target="_blank" className="project-button" style={{backgroundColor: project.colors.darker}}>source code</a>
               </div>
            </motion.div>
